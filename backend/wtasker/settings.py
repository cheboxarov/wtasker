...
SECRET_KEY = 'django-insecure-^uicdljyqh3*jp9=-plo4(gp$jll%g)+l3!-m^+jb1t^yq+te5'
...
WSGI_APPLICATION = 'wtasker.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.get_value("EMAIL_HOST_USER")